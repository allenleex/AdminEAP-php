...
class AclObjectIdentities
{
     ...
     *
     * @param \ManageBundle\Entity\AclObjectIdentities $parentObjectentity
     *
     * @return AclObjectIdentities
     */
    public function setParentObjectentity(\ManageBundle\Entity\AclObjectIdentities $parentObjectentity = null)
    {
     ...
     * Add ancestor
     *
     * @param \ManageBundle\Entity\AclObjectIdentities $ancestor
     *
     * @return AclObjectIdentities
     */
    public function addAncestor(\ManageBundle\Entity\AclObjectIdentities $ancestor)
    {
     ...
     * @param \ManageBundle\Entity\AclObjectIdentities $ancestor
     */
    public function removeAncestor(\ManageBundle\Entity\AclObjectIdentities $ancestor)
    {
