...
class SetmodelformController extends Controller
{
    public function listAction()
    {
        ...
        {
            case 'modelattr_list':
                $result = $this->get('db.model_form_attr')->findBy($map);
                $result['columnList'] = self::getModelAttrColumn();
                break;
            default:
                $result = $this->get('db.model_form')->findBy($map);
    ...
    public function editAction()
    {
        ...
        $this->parameters['info'] = $this->get('db.model_form')->findOneBy($map);
    ...
    public function editattrAction()
    {
        $map = array();
        $map['id'] = (int)$this->get('request')->get('id',0);
        $this->parameters['info'] = $this->get('db.model_form_attr')->findOneBy($map);
        return parent::render();
    }
    ...
    public function saveAction()
    {
        if($this->get('request')->getMethod() == "POST")
        {
            ...
            if($id>0)
                $this->get('db.model_form')->update($id, $data);
            else
                $this->get('db.model_form')->add($data);
    ...
    public function saveattrAction()
    {
        if($this->get('request')->getMethod() == "POST")
        {
            ...
            if($id>0)
                $this->get('db.model_form_attr')->update($id, $data);
            else
                $this->get('db.model_form_attr')->add($data);
    ...
    private function getColumnList()
    {
        ...
        $columnList[1]['key'] = 'name';
        $columnList[1]['id'] = '';
        $columnList[1]['header'] = '标识';
        $columnList[1]['type'] = 'ro';
        $columnList[1]['classType'] = '';
        $columnList[1]['align'] = 'center';
        $columnList[1]['allowSort'] = true;
        $columnList[1]['allowSearch'] = false;
        $columnList[1]['hidden'] = false;
        $columnList[1]['enableTooltip'] = true;
        $columnList[1]['color'] = '';
        ...
        $columnList[1]['operatorObject'] = array('%0 LIKE %1');
    
        $columnList[2]['key'] = 'title';
        $columnList[2]['id'] = '';
        $columnList[2]['header'] = '名称';
        ...
        $columnList[4]['key'] = 'remark';
        $columnList[4]['id'] = '';
        $columnList[4]['header'] = '备注';
    ...
    private function getModelAttrColumn()
    {
        ...
        $columnList[2]['key'] = 'label';
        $columnList[2]['id'] = '';
        $columnList[2]['header'] = '注释';
        $columnList[2]['type'] = 'ro';
        $columnList[2]['classType'] = '';
        $columnList[2]['align'] = 'center';
        $columnList[2]['allowSort'] = true;
        ...
        $columnList[3]['key'] = 'type';
        $columnList[3]['id'] = '';
        $columnList[3]['header'] = '类型';
        $columnList[3]['type'] = 'ro';
        $columnList[3]['classType'] = '';
        $columnList[3]['align'] = 'center';
        $columnList[3]['allowSort'] = true;
        ...
        $columnList[5]['key'] = 'required';
        $columnList[5]['id'] = '';
        $columnList[5]['header'] = '是否必填';
        $columnList[5]['type'] = 'ro';
        $columnList[5]['classType'] = '';
        $columnList[5]['align'] = 'center';
        $columnList[5]['allowSort'] = false;
        ...
        $columnList[6]['key'] = 'bundle';
        $columnList[6]['id'] = '';
        $columnList[6]['header'] = 'Bundle';
        ...
        $columnList[6]['operatorObject'] = array('%0 = %1');
